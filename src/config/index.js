...
import express, { json } from 'express';         // Framework para construir el servidor web
import morgan from 'morgan';           // Middleware para mostrar las peticiones HTTP por consola
import cors from 'cors';               // Middleware para permitir solicitudes desde otro origen (CORS)
...
app.use('/routes/cliente', require('./routes/cliente.route'));
